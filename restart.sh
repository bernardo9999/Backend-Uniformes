...
echo "############ Inicializando Uniformes ###########"

curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "1", "status": "Ativo", "funcionario": "Jason Vorhees", "matricula": "7645", "area": "Sinistros", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "2", "status": "Retornado", "funcionario": "Frederick Krueger", "matricula": "34342", "area": "Vistoria", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "3", "status": "Descartado", "funcionario": "Michael Myers", "matricula": "6543", "area": "Vistoria", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "4", "status": "Ativo", "funcionario": "Norman Bates", "matricula": "9865", "area": "Sinistros", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "5", "status": "Ativo", "funcionario": "Patrick Bateman", "matricula": "2778", "area": "Sinistros", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "6", "status": "Ativo", "funcionario": "Bruce Shark", "matricula": "7554", "area": "Sinistros", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "7", "status": "Retornado", "funcionario": "Leather Face", "matricula": "1234", "area": "Vistoria", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "8", "status": "Retornado", "funcionario": "Hannibal Lecter", "matricula": "1543", "area": "Vistoria", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "9", "status": "Ativo", "funcionario": "Bob Gray", "matricula": "1832", "area": "Sinistros", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "10", "status": "Ativo", "funcionario": "Jack Torrance", "matricula": "6788", "area": "Vistoria", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "11", "status": "Ativo", "funcionario": "Carrie White", "matricula": "6742", "area": "Vistoria", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
curl http://localhost:8000/uniformes/createUniforme -d '{"id": "5","lote_id":"4","uniforme": {"rfid": "12", "status": "Descartado", "funcionario": "Ash Williams", "matricula": "6432", "area": "Sinistros", "data": "2020-06-29T19:20:31.361Z"}}' -H "Content-Type: application/json" --request POST
